...
url_pipeline = 'http://elasticsearch:9200/_ingest/pipeline/projet_3_pipeline'
url_index = 'http://elasticsearch:9200/projet_3'
...
def transform():
	global header_name
	input_file = open('/fill/top250-00-19.csv', 'r')
	output_file = open('/home/top250-00-19_modified.csv', 'w')
...
def exe_script():
	os.system('mv insert.sh /home/insert.sh')
	os.system('cd home')
	os.system('./insert.sh')
